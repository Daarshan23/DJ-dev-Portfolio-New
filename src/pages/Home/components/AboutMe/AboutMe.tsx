            ...
            <div className="flex flex-col items-center md:justify-center md:flex-row sm:gap-24 gap-14 sm:mt-10 mt-5 overflow-hidden">
                ...
                >
                    <p className="text-primary break-words text-lg md:text-2xl">
                        ...
                        as a developer. */}
                         Enthusiastic and detail-oriented React Frontend Developer with a strong foundation in modern web technologies and a passion for creating 
                        responsive, user-friendly web applications. Proficient in HTML, CSS, JavaScript, and the React ecosystem, including Redux, React Router, and hooks. 
Skilled in translating design specifications into functional code, optimizing web performance, and ensuring cross-browser compatibility. 
Demonstrated ability to collaborate effectively in team environments and a commitment to continuous learning and professional development. 
Ready to contribute to innovative projects and drive exceptional user experiences
                    </p>
